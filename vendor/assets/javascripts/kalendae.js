...
var parseDates = function (input, delimiter, format) {
	...
	do {
		if (input[i]) {
      // JM Mod Start
      // TODO replace this with our own input handler, date formatter, and more
      // sane calendar.
      var parsedDate = moment(input[i], format).hours(12)
      if (input[i].length < 5) {
        // Set the year of this date to this year if the date string we
        // processed was less than 5 characters (e.g. 3/31 is March, 31st this
        // year).
